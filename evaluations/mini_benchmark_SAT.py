...
benchmark = Benchmark("/home/yanyan/PythonProjects/CAGP-Solver/cagp_solver/mini_benchmark_SAT_solver2")
...
alg_params_to_evaluate = [
    ...
    # {"solver": "Lingeling", "guard_color_constraints": False}, does not support limited solver time
...
if __name__ == "__main__":
    ...
    relative_path = 'cagp_solver/mini_benchmark/simple-polygons-with-holes/*.pol'
