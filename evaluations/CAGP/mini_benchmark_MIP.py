...
benchmark = Benchmark("/home/yanyan/PythonProjects/CAGP-Solver/cagp_solver/benchmarks/mini_benchmark_MIP_with_holes")
...
if __name__ == "__main__":
    ...
    for filename in sorted(files):
        ...
        for alg_params in alg_params_to_evaluate:
            try:
                print(f"Running MIP with {alg_params['parameter_set']} for {instance_name}")
                ...
                print(f"Error with MIP and {alg_params['parameter_set']} for {instance_name}: {e}")
