...
# Get the entry with solver Cadical103, 300 vertices, and highest time
entry = data_set[(data_set['solver'] == 'Cadical103') & (data_set['vertices'] == 300)].nlargest(1, 'time')
