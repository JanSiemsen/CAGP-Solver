...
guard_to_witnesses, initial_witnesses, remaining_witnesses, all_witnesses, GC, G = solver_utils.generate_solver_input(poly)

print('Calculating greedy solution...')
greedyColors, greedySolution = get_greedy_solution(guard_to_witnesses, initial_witnesses, GC)
