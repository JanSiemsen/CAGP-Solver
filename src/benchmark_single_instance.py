...
with open('/home/yanyan/PythonProjects/CAGP-Solver/simple-polygons-with-holes/g1_simple-simple_125:500v-50h_1.pol') as f:
    vertices = f.readline().split()
    linear_rings = []
...
guards, guard_to_witnesses, witness_to_guards, initial_witnesses, all_witnesses, GC, G = solver_utils.generate_solver_input(poly, guards_on_holes=True)
...
CFsolverSAT = CFCAGPSolverSAT(greedyColors, guard_to_witnesses, witness_to_guards, initial_witnesses, all_witnesses, G, solution=greedySolution)
print('Solving SAT...')
start = time.time()
...
# solverCPSAT_MIP = CAGPSolverCPSAT_MIP(greedyColors, poly, guard_to_witnesses, initial_witnesses, all_witnesses, G, edge_clique_covers, solution=greedySolution)
# print('Solving CPSAT...')
# start = time.time()
...
# print('Creating CPSAT solver...')
# solverCPSAT_Mix = CAGPSolverCPSAT_Mix(greedyColors, poly, guard_to_witnesses, initial_witnesses, all_witnesses, G, GC, solution=greedySolution)
# print('Solving CPSAT...')
# start = time.time()
...
# print('Creating CPSAT solver...')
# solverCPSAT_SAT = CAGPSolverCPSAT_SAT(greedyColors, poly, guard_to_witnesses, initial_witnesses, all_witnesses, G, GC, solution=greedySolution)
# print('Solving CPSAT...')
# start = time.time()
...
# print('Creating SAT solver...')
# solverSAT = CAGPSolverSAT(greedyColors, poly, guard_to_witnesses, initial_witnesses, all_witnesses, G, GC, False, solution=greedySolution)
# print('Solving SAT...')
# start = time.time()
...
# print('Creating SAT solver...')
# solverSAT = CAGPSolverSAT(greedyColors, poly, guard_to_witnesses, initial_witnesses, all_witnesses, G, GC, True, solution=greedySolution)
# print('Solving SAT...')
# start = time.time()
# solution = solverSAT.solve()
# end = time.time()
