...
# with open('/home/yanyan/PythonProjects/CAGP-Solver/agp2009a-simplerand/randsimple-300-1.pol') as f:
...
guards, guard_to_witnesses, witness_to_guards, all_guard_to_witnesses, all_witness_to_guards, initial_witnesses, all_witnesses, GC = solver_utils.generate_solver_input(poly, guards_on_holes=True)
...
# CFsolverMIP = CFCAGPSolverMIP(greedyColors, poly, guard_to_witnesses, witness_to_guards, initial_witnesses, all_witnesses, G, solution=greedySolution)
# print('Solving MIP...')
...
print('Creating SAT solver...')
solverSAT = CAGPSolverSAT(greedyColors, guard_to_witnesses, witness_to_guards, initial_witnesses, all_witnesses, GC, True, solution=greedySolution)
print('Solving SAT...')
start = time.time()
solution = solverSAT.solve()
end = time.time()
