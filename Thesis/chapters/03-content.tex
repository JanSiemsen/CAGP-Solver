...
\FOR{i in range(K)}
    ...
    \WHILE{either vertex of edge is in covered\_vertices}
        \STATE Get next edge from sorted edges
    \ENDWHILE
...
\WHILE{candidates is not empty}
    ...
    \IF{v is a neighbor of all vertices in clique}
