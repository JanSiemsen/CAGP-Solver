...
When looking at the cactus plot, one can easily identify SAT as the faster solver with the plot being close to a vertical line from the origin \cref{fig:cactus_all_simple_no_holes}. Next, the MIP and CPSAT SAT solver perform very similarly. Lastly, the  Note that all solvers were able to solve all of the instances.
