...
Looking at the cactus plot, the SAT solver overall performs better than the other solvers, although the difference is not as drastic as for the simple polygons without holes. Next, the MIP solver performs better than the other three solvers on a lot of the instances but on the other hand is only able to solve noticeably fewer instances within the time limit. Both 
