...
Due to the SAT solver being so fast for random simple polygons without holes, one might wonder what the maximum size instance size is that we can solve. To test this, we take 
