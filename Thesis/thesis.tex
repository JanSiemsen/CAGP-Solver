...
\begin{document}
	...
	\begin{titlepage}
		...
		$\ll$Prof. Dr. Sándor Fekete, Institute of Operating Systems and Computer Networks$\gg$\par
		\vfill
		
		\textbf{Second reviewer}\par
		$\ll$Prof. Dr. Roland Meyer, Institute of Theoretical Computer Science$\gg$\par
		\vfill
